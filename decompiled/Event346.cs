...
public class Event346 : EventsSecond
{
	...
	public override void ResultsOfEvents(ref string name, ref string text, int result_num)
	{
		...
		case 1:
			...
			GlobalScript.inst.gameState.data[51] += ((GlobalScript.inst.gameState.data[51] < 33) ? 1 : 0);
			GlobalScript.inst.gameState.modifies[33].active = true;
			break;
		}
	}
}
