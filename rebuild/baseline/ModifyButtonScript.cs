...
public class ModifyButtonScript : MonoBehaviour
{
	...
	private string BuildEconomyModifyText(string rawText, int economyCode)
	{
		...
		string value4 = (flag ? "在自动化经济/最少管制：已禁用" : "При автоматизации/минимальном регулировании: отключается");
		...
		string text10 = (flag ? ("当前经济模式：<color=yellow>" + economyName + "</color>") : ("Текущая модель экономики: <color=yellow>" + economyName + "</color>"));
