...
public class TMPro_InstructionOverlay : MonoBehaviour
{
	...
	private void Awake()
	{
		if (base.enabled)
		{
			...
			GameObject gameObject = new GameObject("帧计数器");
			m_frameCounter_transform = gameObject.transform;
			m_frameCounter_transform.parent = m_camera.transform;
			m_frameCounter_transform.localRotation = Quaternion.identity;
			m_TextMeshPro = gameObject.AddComponent<TextMeshPro>();
			m_TextMeshPro.font = Resources.Load<TMP_FontAsset>("字体与材质/LiberationSans SDF");
			m_TextMeshPro.fontSharedMaterial = Resources.Load<Material>("字体与材质/LiberationSans SDF - Overlay");
