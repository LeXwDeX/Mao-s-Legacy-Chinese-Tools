...
public class Benchmark01_UGUI : MonoBehaviour
{
	...
	private const string label01 = "计数为：</color><#0050FF>";
	...
	private IEnumerator Start()
	{
		if (BenchmarkType == 0)
		{
			...
			m_material02 = Resources.Load<Material>("字体与材质/LiberationSans SDF - BEVEL");
		}
		...
		for (int i = 0; i <= 1000000; i++)
		{
			if (BenchmarkType == 0)
			{
				m_textMeshPro.text = "计数为：</color><#0050FF>" + i % 1000;
				if (i % 1000 == 999)
				{
